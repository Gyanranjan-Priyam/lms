...
export function ChartAreaInteractive({ data }: ChartAreaInteractiveProps) {
  ...
  const total = React.useMemo(() => data?.reduce((acc, curr) => acc + curr.enrollments, 0), [data]);
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">Total enrollments for last 30 days: {total} </span>
