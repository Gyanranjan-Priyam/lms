   ...
   return (
      <Card className="group relative py-0 gap-0">
         ...
         <CardContent className="p-4">
            <Link href={`/courses/${data.slug}`} className="font-medium text-lg line-clamp-2 group-hover:text-primary">
               {data.title}
            </Link>
            ...
            <Link href={`/courses/${data.slug}`} className={buttonVariants({ className: "mt-4 w-full" })}> Learn More<ArrowRight className="size-4"/></Link>
         </CardContent>
      </Card>
   )
}
